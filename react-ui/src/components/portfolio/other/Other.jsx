...
export default function Featured() {
  ...
  const handleOpen = (x) => {
    setOpen(true);
    let boxId = x - 1;
    titleRef.current = Portfolio3[boxId].title;
    descRef.current = Portfolio3[boxId].desc;
    techRef.current = Portfolio3[boxId].tech;
    imgRef.current = Portfolio3[boxId].img;
    linkRef.current = Portfolio3[boxId].link;
  };
