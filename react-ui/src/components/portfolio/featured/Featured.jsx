...
export default function Featured() {
  ...
  const handleOpen = (x) => {
    setOpen(true);
    let boxId = x - 1;
    titleRef.current = featuredPortfolio[boxId].title;
    descRef.current = featuredPortfolio[boxId].desc;
    techRef.current = featuredPortfolio[boxId].tech;
    imgRef.current = featuredPortfolio[boxId].img;
    linkRef.current = featuredPortfolio[boxId].link;
  };
