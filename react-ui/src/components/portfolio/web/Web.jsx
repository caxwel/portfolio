...
export default function Featured() {
  ...
  const handleOpen = (x) => {
    setOpen(true);
    let boxId = x - 1;
    titleRef.current = Portfolio2[boxId].title;
    descRef.current = Portfolio2[boxId].desc;
    techRef.current = Portfolio2[boxId].tech;
    imgRef.current = Portfolio2[boxId].img;
    linkRef.current = Portfolio2[boxId].link;
  };
